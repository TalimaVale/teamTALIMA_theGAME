...
> *Note:* While it is and always will be an online multiplayer game, there are no current plans to expand into a full MMO architecture.
...
Depending on the type of contribution, here are some guidelines to follow so that your feature has the best chance of being merged:
### Programming
...
That being said, a collection of ‘concept art’ (screenshots of other games) pieces which our art style is derived from can be found here: [Concept Art Styles](../ConceptArtStyles)

If you are looking for inspiration in choosing an object to contribute, a list of currently desired art assets can be found here: [List of Desired Art Assets](../DesiredArtAssets)
...
If you are looking for inspiration in choosing a sound to contribute, a list of currently desired sound assets can be found here: [List of Desired Sound Assets](../DesiredSoundAssets)

### Playtesting
If you are interested in playing or hacking theGAME in an effort to improve the project, please submit any bugs you find as an Issue. 

Each bug should be represented as an individual Issue, and should contain details on where to find the bug and ESPECIALLY how to replicate it.
